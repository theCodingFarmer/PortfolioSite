...
const createMessage = (arr) => {
    ...
    document.getElementById('newMessage').innerHTML = (`You are a ${arr[characterNum]._character} with the ability of ${arr[characterNum]._ability[randomNum()]}, while being known for saying ${arr[characterNum]._quote[randomNum()]}`);
}